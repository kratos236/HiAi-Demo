package com.example.kratos.ai_test;
...
public class MainActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        capture.setOnClickListener(new CaptureClicked());
        swit=findViewById(R.id.swit);
        swit.setOnClickListener(new SwitchClicked());
            ...
            imageReader.setOnImageAvailableListener(
                    new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader reader) {
                            ...
                            // 使用IO流将照片写入指定文件
                            File file = new File(MainActivity.this.getCacheDir(), "pic.jpg");
                            FaceAttributesDetector faceAttributes=new FaceAttributesDetector(MainActivity.this);
    ...
    public class CaptureClicked implements View.OnClickListener {
        @Override
    ...
    public class SwitchClicked implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            if (mCameraId == "0")
                mCameraId = "1";
